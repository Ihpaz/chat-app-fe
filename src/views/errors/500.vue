<template>
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white dark:bg-zinc-800">
        <div class="text-center">
            ...
            <h1 class="mt-5 text-[36px] font-bold text-slate-800 dark:text-secondary lg:text-[50px]">500 - Kesalahan Server Internal</h1>
            <p class="text-slate-600 dark:text-gray-50 mt-5 lg:text-lg">Maaf, terjadi kesalahan pada server. <br> Kami sedang bekerja untuk memperbaikinya. Silakan coba lagi nanti.</p>
        </div>
    </div>
</template>
