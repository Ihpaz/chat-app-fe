<template>
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white dark:bg-zinc-800">
        <div class="text-center">
            <div class="inline-flex rounded-full bg-red-100 p-4">
            <div class="rounded-full stroke-red-800 bg-red-200 p-4">
            ...
            <h1 class="mt-5 text-[36px] font-bold text-slate-800 dark:text-secondary lg:text-[50px]">403 - Akses Ditolak</h1>
            <p class="text-slate-600 dark:text-gray-50 mt-5 lg:text-lg">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. <br> Silakan hubungi administrator jika Anda merasa ini adalah kesalahan.</p>
        </div>
    </div>
</template>