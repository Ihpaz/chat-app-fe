<template>
    <div class="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white dark:bg-zinc-800">
        <div class="text-center">
            ...
            <h1 class="mt-5 text-[36px] font-bold text-slate-800 dark:text-secondary lg:text-[50px]">404 - Tidak Ditemukan</h1>
            <p class="text-slate-600 dark:text-gray-50 mt-5 lg:text-lg">Kami tidak bisa menemukan halaman yang kamu cari. <br> Coba periksa kembali alamat URL atau kembali ke halaman beranda.</p>
        </div>
    </div>
</template>
